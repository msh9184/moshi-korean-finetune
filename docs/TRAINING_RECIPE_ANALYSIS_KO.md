...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  1단계: 사전학습 (13K 시간 모노/스테레오 변환)                               │
│  ════════════════════════════════════════════                               │
│    Step 0 → 500:     웜업 (LR: 0 → 3e-5)                                   │
│    Step 500 → 10K:   상수 LR (3e-5, Temp & Dep 동일)                       │
│                                                                             │
│    체크포인트: 500 스텝마다                                                  │
│    핵심 지표: Loss < 6.0, WER 개선 중                                       │
│    소요 시간: ~20-30시간 (32x A100)                                         │
│                                                                             │
│  2단계: 파인튜닝 (13K 시간, 다른 LR 체제)                                   │
│  ════════════════════════════════════════                                   │
│    Step 10K → 10.2K: 웜업 (LR: 0 → 5e-6/1e-5)                              │
│    Step 10.2K → 50K: min_lr까지 코사인 감쇠                                 │
│                                                                             │
│    핵심: TempFormer=5e-6, DepFormer=1e-5 (2배 비율)                         │
│    체크포인트: 1000 스텝마다                                                 │
│    핵심 지표: WER < 30%, Loss < 4.0                                         │
│    소요 시간: ~80-100시간 (32x A100)                                        │
│                                                                             │
│  3단계: 고품질 후속 학습 (선택)                                              │
│  ═══════════════════════════════                                            │
│    데이터: TTS 품질 스테레오 녹음                                            │
