...
# -----------------------------------------------------------------------------
NUM_GPUS=8
CONFIG_FILE="example/korean_moshi_stage1_pretrain_spk.yaml"
LOG_DIR="logs"
TEST_MODE=false
BACKGROUND=false
DRY_RUN=false
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --config, -c FILE        Config YAML file (default: example/korean_v4_fsdp_moshi_spk.yaml)"
...
if [ "${BACKGROUND}" = true ]; then
    ...
    echo "  tensorboard --logdir=./runs/korean_moshi_stage1_pretrain/tensorboard"
    echo ""
...
echo "  Checkpoints: ./runs/korean_moshi_stage1_pretrain/"
echo "  TensorBoard: ./runs/korean_moshi_stage1_pretrain/tensorboard/"
echo "  Samples:     ./runs/korean_moshi_stage1_pretrain/samples/"
echo "  Research:    ./runs/korean_moshi_stage1_pretrain/research/"
echo "  Log file:    ${LOG_FILE}"
echo ""
